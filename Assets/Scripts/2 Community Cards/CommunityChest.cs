...
public class CommunityChest : MonoBehaviour
{
    ...
    List<SCR_CommunityCard> cardDeck = new List<SCR_CommunityCard>();//ÊÎËÎÄÀ ÊÀĞÒÎ×ÅÊ
    List<SCR_CommunityCard> usedCardDeck = new List<SCR_CommunityCard>();//ÊÎËÎÄÀ ÑÁĞÎÑÀ
    ...
    {
        bool isMoving = false;
        //pickedCard = cardDeck[0];//ÂÑÅÃÄÀ ÄÎÑÒÀÅÒÑß ÏÅĞÂÀß ÊÀÊ ÏÎ×ÈÍÈÒÜ ÕÇ ËÎÌÀÅÒÑß //FIX //DESIGN
